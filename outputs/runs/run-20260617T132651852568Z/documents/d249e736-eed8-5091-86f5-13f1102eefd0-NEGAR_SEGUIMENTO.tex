...
\begin{document}
\justifying
\noindent \textbf{Processo n.: }\uline{5000002-00.2025.4.02.5001}

\noindent Verifica-se que a questão objeto da controvérsia jurídica suscitada no recurso manejado pela parte recorrente esteve afetada no representativo da controvérsia - \textbf{Tema n. }\textbf{309} da TNU - (PU no processo n. PEDILEF 5001816-07.2020.4.04.7008/PR),  afetado em 2022-08-18 foi julgado (trânsito em julgado em 2024-02-14), por meio do qual foi elucidada a seguinte questão:

\noindent \textit{"Auxilio-alimentacao integra base de calculo da licenca-premio convertida em pecunia?"}

\noindent Restou firmada a seguinte tese:

\noindent \textit{"O auxilio-alimentacao integra a base de calculo da licenca-premio nao usufruida." (Tema 309 TNU).}
...
\noindent A proposito, consta do acordao hostilizado: (...) Auxilio-alimentacao em licenca-premio
