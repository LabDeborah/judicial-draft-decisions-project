...
\begin{document}
\justifying
\noindent \textbf{Processo n.: }\uline{5014186-94.2025.4.02.5101}
...
{\leftskip=3.1cm\rightskip=0.8cm\parindent=0pt \textit{"Saber se é necessário prévio pedido de prorrogação de benefício de auxílio-doença nas hipóteses conhecidas por "alta programada"."}\par}

\noindent Restou firmada a seguinte tese:

{\leftskip=3.1cm\rightskip=0.8cm\parindent=0pt \textit{"É devido o restabelecimento do auxílio-doença nas hipóteses conhecidas por “alta programada”, independentemente de prévio pedido administrativo de prorrogação. VIDE TEMA 164/TNU" (Tema 4 TNU).}\par}
